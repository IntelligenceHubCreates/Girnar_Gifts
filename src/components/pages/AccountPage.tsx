...
function buildWhatsAppReviewUrl(phone: string, userName: string, products: ReviewableProduct[]): string {
  ...
  const message =
    ...
    `We'd love to hear what you think! Your review helps other customers choose the best gifts. 💛\n\n` +
    `Tap here to share your feedback:\n` +
    `👉 ${brand.url}/account (Reviews tab)\n\n` +
      ...
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.sbNav}>
          ...
          <div className={styles.sbSection}>
            ...
            <button type="button" className={styles.sbItem}>
              ...
              <span className={styles.sbItemLabel}>{brand.shortName} Club</span>
        ...
        <div className={styles.sbClubCard}>
          ...
          <div className={styles.sbClubTop}>
            ...
            <div>
              <div className={styles.sbClubTitle}>{brand.shortName} Club</div>
        ...
        <div className={styles.sbHelpCard}>
          ...
          <div className={styles.sbHelpContacts}>
            <a href={`tel:${brand.phone}`} className={styles.sbHelpContact}>
            ...
            <a href={`mailto:${brand.email.support}`} className={styles.sbHelpContact}>
              <span className={styles.sbHelpContactIcon}>
          ...
          <div className={`${styles.tabWrap} ${styles.desktopOnly}`}>
            ...
            <div className={styles.helpWrap}>
              <div className={styles.helpContactGrid}>
                <a href={`tel:${brand.phone}`} className={styles.helpContactCard}>
                  ...
                  <div className={styles.helpContactSub}>{brand.phone}</div>
                </a>
                <a href={`mailto:${brand.email.support}`} className={styles.helpContactCard}>
                  ...
                  <div className={styles.helpContactSub}>{brand.email.support}</div>
                </a>
                <a href={`https://wa.me/${brand.whatsapp}`} target="_blank" rel="noopener" className={styles.helpContactCard}>
