...
export default function WhatsAppButton() {
  ...
  // Show button after slight delay, hide tooltip after 4s
  useEffect(() => {
  ...
  return (
    <div className={styles.wrap}>
      {/* Tooltip — sibling of the link, not nested inside it, so the
          link's accessible name never mismatches its (icon-only) visible content */}
      {tooltip && (
